...
export type BankCode = NigerianBank['code'];

// Helper: find bank by code
export const getBankByCode = (code: string): NigerianBank | undefined =>
  NIGERIAN_BANKS.find((b) => b.code === code);

// Helper: find bank by name (case-insensitive partial match)
export const searchBanksByName = (query: string): NigerianBank[] =>
  NIGERIAN_BANKS.filter((b) =>
    b.name.toLowerCase().includes(query.toLowerCase()),
  );

export const VALID_BANK_CODES = NIGERIAN_BANKS.map((b) => b.code);
